...
// CompanyIntro 컴포넌트는 교육 페이지의 상단 소개 영역을 렌더링합니다.
        ...
        <section className="px-6 py-8">
            <div className="toss-container">
                <div
                    ...
                    <div className="relative flex flex-col md:flex-row items-center justify-between gap-10 px-10 py-16">
                        {/* 좌측 텍스트 영역 */}
                        <div className="relative flex flex-col gap-6 md:max-w-xl text-center md:text-left">
        <span className="toss-tag self-center uppercase md:self-start">
            {eyebrow}
                        ...
                        <div className="md:w-1/3 w-full flex justify-center md:justify-end">
                            <img
                                src="/introBG.png" // ✅ 원하는 이미지 경로로 변경
                                alt="ESG 협회 이미지"
                                className="max-w-[280px] rounded-2xl object-contain"
                            />
                        </div>
                    </div>
